...
ui-options-tts-queue = Очередь ТТС в рации
...
ui-options-admin-playerlist-separate-symbols = Показывать отдельные символы для каждого типа роли антагониста
ui-options-admin-playerlist-character-color = Подсвечивать имена персонажей-антагонистов
ui-options-admin-playerlist-roletype-color = Подсвечивать типы ролей
...
ui-options-enable-overlay-playtime = Показывать время игры
ui-options-enable-overlay-starting-job = Показывать начальную профессию
ui-options-overlay-merge-distance = Дистанция группировки стека
ui-options-overlay-ghost-fade-distance = Расстояние затухания оверлея призраков от мыши
ui-options-overlay-ghost-hide-distance = Расстояние скрытия оверлея призраков от мыши
