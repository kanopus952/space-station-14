...
using Content.Client._Sunrise.Donation;
...
public sealed partial class SunriseLobbyGui : UIScreen
{
    ...
    public SunriseLobbyGui()
    {
        ...
        var sponsorStripTex = _resource.GetTexture("/Textures/_Sunrise/Interface/Lobby/sponsor_strip.png");
        var sponsorStripBack = new StyleBoxTexture
        {
            Texture = sponsorStripTex,
        };
        sponsorStripBack.SetPatchMargin(StyleBox.Margin.All, 14);

        LeftTopPanel.PanelOverride = _back;

        SponsorStripPanel.PanelOverride = sponsorStripBack;
