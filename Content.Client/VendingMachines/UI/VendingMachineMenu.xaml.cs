...
public sealed partial class VendingMachineMenu : FancyWindow
{
    ...
    public VendingMachineMenu()
    {
        ...
        SetSize = new Vector2(450, 150); // Sunrise-Edit - оставляем увеличенную начальную ширину окна
    ...
    public void Populate(List<VendingMachineInventoryEntry> inventory, bool enabled)
    {
        ...
        for (var i = 0; i < inventory.Count; i++)
        {
            ...
            if (!_dummies.TryGetValue(entry.ID, out var dummy) || !_entityManager.EntityExists(dummy))
            {
                ...
                _dummies[entry.ID] = dummy; // Sunrise-Edit - заменяем удалённый клиентский манекен
            }
    ...
    public void UpdateAmounts(List<VendingMachineInventoryEntry> cachedInventory, bool enabled)
    {
        ...
        foreach (var proto in _dummies.Keys)
        {
            ...
            if (!_entityManager.EntityExists(dummy))
            {
                ...
                _dummies[proto] = dummy; // Sunrise-Edit - восстанавливаем удалённый клиентский манекен
            }
