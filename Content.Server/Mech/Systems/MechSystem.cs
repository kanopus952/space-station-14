...
public sealed partial class MechSystem : SharedMechSystem
{
    ...
    {
        base.Initialize();
        InitializeSunrise(); // Sunrise-Edit - регистрируем серверные расширения мехов
    }
    ...
    private void OnInteractUsing(EntityUid uid, MechComponent component, InteractUsingEvent args)
    {
        ...
        if (component.BatterySlot.ContainedEntity == null &&
            ...
            _tag.HasTag(args.Used, PowerCageTag)) // Sunrise-Edit - мехи используют только силовые ячейки
        {
    ...
    private void OnMechEntry(EntityUid uid, MechComponent component, MechEntryEvent args)
    {
        ...
        if (!TryPrepareSunriseEntry((uid, component), args.User)) // Sunrise-Edit - дополнительные ограничения Sunrise
            return;
    ...
    private void OnDamageChanged(EntityUid uid, MechComponent component, DamageChangedEvent args)
    {
        ...
        SaySunriseCritMessage(uid, component, totalDamage, args.DamageIncreased); // Sunrise-Edit - озвучиваем пороги повреждения
    }
