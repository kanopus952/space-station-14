...
public sealed class PopupEntityEvent(
    ...
    GameTick tick,
    NetEntity uid,
    NetEntity? origin = null) : PopupEvent(message, type, tick)
{
    /// <summary>
    ...
    /// <summary>
    /// Entity whose popup-related client visuals should be updated.
    /// </summary>
    // Sunrise-Edit: источник нужен клиентским иконкам указания.
    public NetEntity? Origin = origin;
...
public enum PopupType : byte
{
    ...
    // Sunrise added start - дополнительные варианты отображения форковых popup.
    SmallFloating,
    MediumCautionFloating,
    LargeGreen
    // Sunrise added end
}
