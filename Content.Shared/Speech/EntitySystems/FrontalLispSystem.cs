...
public sealed partial class FrontalLispSystem : RelayAccentSystem<FrontalLispComponent> // Sunrise-Edit - русская локализация вынесена в partial
{
    // @formatter:off
    ...
    public override string Accentuate(string message, Entity<FrontalLispComponent>? ent = null)
    {
        ...
        return AccentuateSunrise(message, ent); // Sunrise-Edit - применяем русскую часть акцента
    }
}
